...
Cards are sized A5 (half the size of cards provided), orientated so they are perpendicular to the ground (so they face the front of the buggy), and are spaced no more than 2 meters apart. The following colour code is to be used for navigation:

Colour | Instruction
---------|---------
Red | Turn Right 90
Green (dark) | Turn Left 90
Blue (light)| Turn 180
Yellow | Turn Right 30
Orange | Turn Left 30
Pink | Turn Right 60
Blue (dark) | Turn Left 60
Purple | Turn Right 135
Green (light) | Turn Left 135
Black | Finish (return home)

For your reference, the colours are named as follows.

![Colour code](gifs/colours.png)

An example course to navigate is shown below. You do not know in advance which colours will be in the course or how many.

![Navi Diagram](gifs/maze.gif)

You can assume that the floor is a hard surface e.g. wood, tiles, etc.
...
Please use this GitHub repo to manage your software development and submit your project code. You will additionally be required to upload a presentation and demonstration of your solution via MS Teams.
...
The included i2c.c/h files contain functions to help you get started with I2C communication. The first function below sets up the MSSP module as an I2C master device and configures the necessary pins.
	...
	void I2C_2_Master_Init(unsigned long i2c_clock)
	{
		//i2c config  
